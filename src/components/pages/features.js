...
const Features = () => {
  return (
    <div id="feature" className="w-full min-h-screen p-2 flex items-center bg-gradient-to-b from-white to-gray-400">
      ...
      <h2 className="text-4xl font-bold text-gray-800 mb-6">Feature <span className="text-blue-600">Properties</span></h2>
        ...
        <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                ...
                <button className="mt-6 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-300">
                  View Details
                </button>
              </div>
            </div>
